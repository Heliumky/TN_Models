...
input_mps_path = "2d_dmrg_N=8.pkl"
...
Z0 = ptut.get_2D_mesh_eles_mps (phi1, bxs, bys)
Z1 = ptut.get_2D_mesh_eles_mps (phi2, bxs, bys)
...
ax[0].set_title(f'$\phi$ 1 Density (Energy = {energy_1s:.8f})')
...
ax[1].set_title(f'$\phi$ 2 Density (Energy = {energy_1s:.8f})')
