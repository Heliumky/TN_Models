...
if __name__ == '__main__':
    ...
    os.system('python3 tci.py '+str(2*N)+' '+str(rescale)+' '+str(shift)+' '+str(cutoff)+' '+str(factor)+' '+str(0)+' --1D_interact')
    inter_MPS  = tci.load_mps(f'fit{2*N}_{0.0}.mps.npy')
    ...
    # Create MPS
    psi = twut.make_product_mps (N, parity)


    # Define the bond dimensions for the sweeps
    maxdims = [2]*10 + [4]*50 + [8]*150 + [16]*150 + [32]*50
    #maxdims = [2]*10
    cutoff = 1e-12
